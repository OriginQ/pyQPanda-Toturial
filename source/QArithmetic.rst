...
.. code-block:: python
   ...
   if __name__ == "__main__":
      ...
      # (4/1+1-3)*5=10
      prog.insert(bind_data(4,qvec3)) \
         .insert(bind_data(1,qvec2)) \
         .insert(QDivider(qvec3, qvec2, qvec1, qdivvec, cbit)) \
         .insert(bind_data(1,qvec2)) \
         .insert(bind_data(1,qvec2)) \
         .insert(QAdd(qvec1, qvec2, qsubvec)) \
         .insert(bind_data(1,qvec2)) \
         .insert(bind_data(3,qvec2)) \
         .insert(QSub(qvec1, qvec2, qsubvec)) \
         .insert(bind_data(3,qvec2)) \
         .insert(bind_data(5,qvec2)) \
         .insert(QMul(qvec1, qvec2, qvec3, qmulvec)) \
         .insert(bind_data(5,qvec2)) 

      # 对量子程序进行概率测量
      result = prob_run_dict(prog, qmulvec)
